            ...
            <div className="container">
                <div className="hero-content">
                    <div className="hero-text">
                        ...
                        <p className="hero-summary slide-in">{basics.summary}</p>

                        <div className="hero-location slide-in">
                            <svg
                    ...
                    <div className="hero-image-wrapper slide-in">
                        ...
                        <img
                            ...
                            onError={(e) => {
                                e.currentTarget.src = 'https://avatars.githubusercontent.com/u/17396895?v=4' + basics.name.charAt(0);
                            }}
                        />
                    </div>
                </div>
